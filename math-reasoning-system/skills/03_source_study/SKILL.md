...
**Goal:** Dissect relevant mathematical literature to extract techniques, reusable lemmas, limitations, and possible extensions. Write findings to `artifacts/02_literature_review.md`.
