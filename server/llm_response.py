...
provider_info = {
    "OpenAI": {
        ...
        "default_leanaide_model": "gpt-5.5",
    ...
    "OpenRouter": {
        ...
        "default_leanaide_model": "openai/gpt-5.5",
...
def image_solution(image_path: str, provider = "openai", model: str = "gpt-5.5"):
...
def solution_from_images(image_paths, provider = "openai", model: str = "gpt-5.5"):
    combined_text = ""
...
def model_response_gen(prompt:str, task:str = "", provider = "openai", model:str ="gpt-5.5", json_output: bool = False, json_schema = SCHEMA_JSON, pdf_val = None, paper_input: bool = False):
    """
...
def gen_thmpf_json(thm: str, pf: str, provider = "openai", model: str = "gpt-5.5"):
...
def check_reprompt(thm: str, pf: str, output: str, provider = "openai", model: str = "gpt-5.5"):
...
def reprompt_gen_thmpf_json(thm: str, pf: str, output: str, error_msg: str, provider = "openai", model: str = "gpt-5.5"):
    # re-prompt
    response = model_response_gen(
...
def gen_paper_json(paper_text, pdf_input:bool = False, provider = "openai", model: str = "gpt-5.5"):
